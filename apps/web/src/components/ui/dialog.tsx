...
const DialogContent = ({
  ...
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-md p-1 text-slate-400 transition hover:bg-slate-100 hover:text-slate-700">
        <X className="size-4" />
...
const DialogTitle = ({
  ...
  <DialogPrimitive.Title className={cn("text-lg font-bold text-slate-950", className)} {...props} />
);
